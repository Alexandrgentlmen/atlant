...
/* harmony import */ var _components_ya_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/ya-map */ "./src/js/components/ya-map.js");
/* harmony import */ var _components_ya_map__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_ya_map__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_video__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/video */ "./src/js/components/video.js");
/* harmony import */ var _components_video__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_video__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_scrollTop__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/scrollTop */ "./src/js/components/scrollTop.js");
/* harmony import */ var _components_scrollTop__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_scrollTop__WEBPACK_IMPORTED_MODULE_3__);
...
const scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_2___default())('.scrollToTop');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const formCoordBottom = getCoords(form).bottom - 50;
  const scrollBtn = document.querySelector('.scrollToTop');
  const scrollBtnCoord = offsetPosition(scrollBtn);
  window.onscroll = () => {
    let arrowOnlineCoord = scrollBtnCoord[1] + window.scrollY;
    if (window.scrollY > 500) {
      scrollBtn.classList.remove('isShowBtn_hide');
    } else if (window.scrollY < 500) {
      scrollBtn.classList.add('isShowBtn_hide');
    }
    if (arrowOnlineCoord > formCoordBottom) {
      scrollBtn.classList.add('scrollToTop__absolutely');
    } else {
      scrollBtn.classList.remove('scrollToTop__absolutely');
    }
  };
});
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.customer-reviews__slider', {
  slidesPerView: 'auto',
  spaceBetween: 30
});
...
playBtn.addEventListener('click', () => {
  videoBlock.classList.add('video-block__played');
  video.play();
  video.controls = true;
  playBtn.classList.add('video-block__btn--checked');
});
video.onpause = function () {
  videoBlock.classList.remove('video-block__played');
  video.controls = false;
  playBtn.classList.remove('video-block__btn--checked');
};
...
let centerMark = [59.930336, 30.367234];
